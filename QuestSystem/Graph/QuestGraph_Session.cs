    ...
    internal sealed partial class QuestGraph
    {
        ...
        private sealed class Session : IDisposable
        {
            ...
            public sealed class PlayerState
            {
                ...
                public IReadOnlyList<PlayerCursor> ChainsCompleted => chainsCompleted.ToList();
                ...
                public int[] CaptureSnapshot()
                {
                    ...
                    int idx = 1;
                    foreach (var cursor in chainsCompleted.Reverse())
                    {
                        array[idx++] = cursor.Root;
                        array[idx++] = cursor.Node;
                    }

                    foreach (var nodeId in currentChainFootprints.Reverse())
                    {
                        array[idx++] = nodeId;
                    }
