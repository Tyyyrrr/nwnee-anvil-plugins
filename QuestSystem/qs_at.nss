...
// - "CompleteStage"            "questA:2,4,6; questB:10"   - grant reward for completing the stage and auto advance to the next stage (if any) -- works only for stages with no objectives!
// - "TakeItemTag"              "itemATag:10; itemBTag"     (amount is optional, default is 1)
// - "TakeItemResRef"           "itemATag:10; itemBTag"     
// - "TakeItemTagResRef"        "itemATag:itemAResRef:10; itemBTag:itemBResRef"
//////////////////////////
