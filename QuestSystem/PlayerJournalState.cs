...
namespace QuestSystem
{
    ...
    {
        public static readonly string StageSeparatorString = "____________________\n\n";

        public static readonly string ObjectiveSeparatorString = "--------------------------------\n";
        ...
        public void Update(NwPlayer player, Quest quest, StageNodeWrapper stage, bool completed = false)
        {
            ...
            entry.sText = text;
            entry.nQuestCompleted = completed ? 1 : 0;
        ...
        public void Clear(NwPlayer player, string tag)
        {
            _stringBuilder.Clear();
            var entry = player.GetJournalEntry(tag);
            if(entry == null) return;
            entry.QuestDisplayed = false;
