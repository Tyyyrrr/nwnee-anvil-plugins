...
{
    internal sealed class PortraitPickerModel
    {
        ...
        public PortraitPickerModel(IEnumerable<string> resRefs, int columnCount)
        {
        ...
        {
            var index = row * PortraitPickerView.ColumnCount + column;
