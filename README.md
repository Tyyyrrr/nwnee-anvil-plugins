...
_The architecture is intentionally modular, but __compatibility with the target server is prioritized__, so adaptation __is__ possible — but __not__ plug‑and‑play._
